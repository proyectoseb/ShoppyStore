    ...
    <form id="com-form-login" action="<?php echo JRoute::_('index.php', $this->useXHTML, $this->useSSL); ?>" method="post" name="com-login" >
      <fieldset class="userdata">
        ...
        <div class="width30 floatleft" id="com-form-login-remember">
          <input type="submit" name="Submit" class="inputbox ipbox" value="<?php echo vmText::_('COM_VIRTUEMART_LOGIN') ?>" />
...
<?php  } else if ( $user->id ) { ?>
      ...
      <span class="name"><?php echo vmText::sprintf( 'COM_VIRTUEMART_HINAME', $user->name ); ?></span>
