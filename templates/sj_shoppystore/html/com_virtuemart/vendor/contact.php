...
<div class="clearfix"></div>
        ...
        <div class="form-field">
            ...
            <form method="post" class="form-validate" action="<?php echo JRoute::_('index.php') ; ?>" name="askform" id="askform">
                ...
                <label>
                <span><?php echo vmText::_('COM_VIRTUEMART_USER_FORM_NAME')  ?> : </span>
                <input type="text" class="validate[required,minSize[4],maxSize[64]]" value="<?php echo $this->user->name ?>" name="name" id="name" size="30"  validation="required name"/></label>
                <label>
                <span><?php echo vmText::_('COM_VIRTUEMART_USER_FORM_EMAIL')  ?> : </span>
                <input type="text" class="validate[required,custom[email]]" value="<?php echo $this->user->email ?>" name="email" id="email" size="30"  validation="required email"/></label>
                <label class="t-area">
                   <span><?php
