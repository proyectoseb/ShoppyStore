...
<div class="dropdown wrap-vmsearch">
    ...
    <div class="dropdown-menu" role="menu">
        ...
        <!--BEGIN Search Box -->
<form action="<?php echo JRoute::_('index.php?option=com_virtuemart&view=category&search=true&limitstart=0&virtuemart_category_id='.$category_id ); ?>" method="get" role="form">
